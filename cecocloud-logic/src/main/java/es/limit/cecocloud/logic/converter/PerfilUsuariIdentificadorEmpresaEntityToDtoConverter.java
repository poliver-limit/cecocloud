 ...
 */
@Component
public class PerfilUsuariIdentificadorEmpresaEntityToDtoConverter extends AbstractEntityToDtoConverter<PerfilUsuariIdentificadorEmpresaEntity, PerfilUsuariIdentificadorEmpresa> {
