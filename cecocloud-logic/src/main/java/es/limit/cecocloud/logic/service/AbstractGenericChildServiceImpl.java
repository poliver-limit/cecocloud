 ...
 */
public abstract class AbstractGenericChildServiceImpl<D extends IdentificableChild<PID, ID>, P extends AbstractEntity<?, PID>, E extends AbstractChildEntity<P, D, ID>, PID extends Serializable, ID extends Serializable> extends AbstractServiceImpl<D, P, E, ID> implements GenericChildService<D, PID, ID> {
