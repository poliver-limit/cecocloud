 ...
 */
@Component
public class PerfilUsuariEmpresaEntityToDtoConverter extends AbstractEntityToDtoConverter<PerfilUsuariIdentificadorEmpresaEntity, PerfilUsuariIdentificadorEmpresa> {
