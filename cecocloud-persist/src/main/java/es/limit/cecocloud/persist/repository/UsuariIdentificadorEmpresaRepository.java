...
public interface UsuariIdentificadorEmpresaRepository extends BaseRepository<UsuariIdentificadorEmpresaEntity, Long> {
	...
	Optional<UsuariIdentificadorEmpresaEntity> findByUsuariIdentificadorUsuariEmbeddedCodiAndAndUsuariIdentificadorIdentificadorIdAndEmpresaId(
			String usuariCodi,
	...
	List<UsuariIdentificadorEmpresaEntity> findByEmpresa(EmpresaEntity empresa);
