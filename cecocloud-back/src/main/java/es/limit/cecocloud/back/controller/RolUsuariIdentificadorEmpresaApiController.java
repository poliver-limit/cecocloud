 ...
 */
@RestController
@RequestMapping(GenericController.API_PATH + "/rolUsuariIdentificadorEmpreses")
public class RolUsuariIdentificadorEmpresaApiController extends AbstractIdentificableWithCompositePkApiController<RolUsuariIdentificadorEmpresa> {
