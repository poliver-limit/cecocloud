...
export class CompanyiaUsuarisFormComponent implements OnDestroy {
	...
	private createPerfilEmpresa(perfilUsuariEmpresa, index) {
		this.perfilUsuariIdentificadorEmpresaService.create(<PerfilUsuariEmpresa>perfilUsuariEmpresa).subscribe((resposta: any) => {
	...
	constructor(
		...
		public identificadorUsuariService: IdentificadorUsuarisService,
		...
		this.routeSub = this.route.params.subscribe((params) => {
			if (params.id) {
				...
				this.identificadorUsuariService.whenReady().subscribe((restapiProfile: BngRestapiProfile) => {
					...
					this.identificadorUsuariService.get(this.usuariIdentificadorId).subscribe((usuariCompanyia: Resource) => {
