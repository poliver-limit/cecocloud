...
@AttributeOverrides({
	...
	@AttributeOverride(name = "embedded.citaDataInici", column = @Column(name = "ptv_citdatini")),
	@AttributeOverride(name = "embedded.citaDataFi", column = @Column(name = "ptv_citdatfin")),
