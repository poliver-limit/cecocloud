...
@Table(
		name = "tges_prj",
		indexes = {
				@Index(name = "iges_prj_idf_fk", columnList = "prj_idf_cod"),
...
public class ProjecteEntity extends AbstractWithIdentificadorEntity<Projecte, ProjectePk>{
	...
	@Column(name = "prj_scl_cod", length = 4, insertable = false, updatable = false)
	...
	@Column(name = "prj_tpj_cod", length = 8, insertable = false, updatable = false)
