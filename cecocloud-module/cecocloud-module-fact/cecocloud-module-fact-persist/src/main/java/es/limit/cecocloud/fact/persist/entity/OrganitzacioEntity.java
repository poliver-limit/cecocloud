...
/**
 * Entitat de model de dades que conté la informació sobre el tipus d'una
 * organització.
 * 
...
@Entity
@Table(name = "tges_org", indexes = { @Index(name = "iges_org_idf_fk", columnList = "org_idf_cod"),
...
public class OrganitzacioEntity
	...
	@JoinColumns(
			value = {
					@JoinColumn(name = "org_idf_cod", referencedColumnName = "cpo_idf_cod", insertable = false, updatable = false),
					@JoinColumn(name = "org_cpo_cod", referencedColumnName = "cpo_cod", insertable = false, updatable = false)
			},
