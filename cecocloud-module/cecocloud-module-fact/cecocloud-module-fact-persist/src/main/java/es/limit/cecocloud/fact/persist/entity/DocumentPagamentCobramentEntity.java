...
@AttributeOverrides({
	...
	@AttributeOverride(name = "embedded.numeroDias", column = @Column(name = "dpg_numdiaval")),
	@AttributeOverride(name = "embedded.diaEfectosNegociados", column = @Column(name = "dpg_diaefeneg")),
	@AttributeOverride(name = "embedded.codigoContable", column = @Column(name = "dpg_codcmp")),
	@AttributeOverride(name = "embedded.codigoFacturaElectronica", column = @Column(name = "dpg_codfacele")),
	@AttributeOverride(name = "embedded.percentatgeComisio", column = @Column(name = "dpg_percmi")),
	@AttributeOverride(name = "embedded.compteContableComissio", column = @Column(name = "dpg_cnccmp")),
	@AttributeOverride(name = "embedded.concepteContable", column = @Column(name = "dpg_ctecmpcmi")),
	@AttributeOverride(name = "embedded.compteContableOrigenIngressos", column = @Column(name = "dpg_ctecmping")),
	@AttributeOverride(name = "embedded.tipusSeientIngressos", column = @Column(name = "dpg_tipasiing")),
	@AttributeOverride(name = "embedded.diariContableIngressos", column = @Column(name = "dpg_dricmping")),
	@AttributeOverride(name = "embedded.diariContableIngressos2", column = @Column(name = "dpg_dricmping002")),
	@AttributeOverride(name = "embedded.compteContableDestiPagos", column = @Column(name = "dpg_ctecmppag")),
	@AttributeOverride(name = "embedded.tipusSeientPagos", column = @Column(name = "dpg_tipasipag")),
	@AttributeOverride(name = "embedded.diariContablePagos", column = @Column(name = "dpg_dricmppag")),
	@AttributeOverride(name = "embedded.diariContablePagos2", column = @Column(name = "dpg_dricmppag002")),
	@AttributeOverride(name = "embedded.controlarEfectes", column = @Column(name = "dpg_crlefecob")),
	@AttributeOverride(name = "embedded.agruparVencimentsRemeses", column = @Column(name = "dpg_acuvto")),
	@AttributeOverride(name = "embedded.aplicarDescuentosProntoPago", column = @Column(name = "dpg_apldteppg")),
