...
import es.limit.cecocloud.fact.persist.entity.PressupostLiniaEntity.PressupostLiniaEntityListener;
...
@Entity(name = "factPressupostLiniaEntity")
@Table(
		name = "tges_lpr",
		indexes = {				
				@Index(name = "rges_lpr_pk", columnList = "lpr_idf_cod,lpr_emp_cod,lpr_pre_cod,lpr_num", unique = true),
				@Index(name = "iges_lpr_emp_fk", columnList = "lpr_idf_cod, lpr_emp_cod"),
				@Index(name = "iges_lpr_pre_fk", columnList = "lpr_idf_cod, lpr_emp_cod, lpr_pre_cod")
		}
)
...
public class PressupostLiniaEntity extends AbstractWithIdentificadorAuditableEntity<PressupostLinia, PressupostLiniaPk> {
	...
	@JoinColumns(
				...
				foreignKey = @ForeignKey(name = "rges_lpr_emp_fk"))
	...
	@JoinColumns(
				...
				foreignKey = @ForeignKey(name = "rges_lpr_pre_fk"))
	...
	@JoinColumns(
				...
				foreignKey = @ForeignKey(name = "rges_lpr_art_fk"))
