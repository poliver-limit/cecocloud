...
public class ZonaFactEntity extends AbstractAuditableCompositePkEntity<ZonaFact, ZonaFactPk> {

	@Embedded
	protected ZonaFact embedded;
	...
	@Override
	public void update(ZonaFact embedded) {
		this.embedded = embedded;
	}
