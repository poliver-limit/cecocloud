...
@AttributeOverrides({
	...
	@AttributeOverride(name = "embedded.dadesContacte", column = @Column(name = "rgc_dac", length = 500)),
	@AttributeOverride(name = "embedded.comentaris", column = @Column(name = "rgc_com", length = 1500)),
