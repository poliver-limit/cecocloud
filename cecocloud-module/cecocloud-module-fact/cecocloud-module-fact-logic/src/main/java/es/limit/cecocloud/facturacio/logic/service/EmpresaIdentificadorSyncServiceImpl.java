...
import es.limit.cecocloud.facturacio.persist.repository.IdentificadorRepository;
...
public class EmpresaIdentificadorSyncServiceImpl implements EmpresaIdentificadorSyncService {
	...
	public void identificadorCreate(Identificador identificador) {
		es.limit.cecocloud.facturacio.logic.api.dto.Identificador identificadorFact = new es.limit.cecocloud.facturacio.logic.api.dto.Identificador();
