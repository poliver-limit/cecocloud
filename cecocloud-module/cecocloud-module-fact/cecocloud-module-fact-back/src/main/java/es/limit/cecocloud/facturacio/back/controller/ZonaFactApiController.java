...
public class ZonaFactApiController extends AbstractIdentificableApiController<ZonaFact, String> {

	@Autowired
	private EmpresaService empresaService;

	@Override
	protected void completeDtoWithSession(ZonaFact dto, Object userSession) {
