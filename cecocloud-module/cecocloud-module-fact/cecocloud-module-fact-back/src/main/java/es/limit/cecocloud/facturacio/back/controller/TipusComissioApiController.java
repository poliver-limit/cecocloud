 ...
 */
@RestController
@RequestMapping(FactModuleConfig.API_PATH + "/tipusComissions")
public class TipusComissioApiController extends AbstractIdentificableWithIdentificadorApiController<TipusComissio> {
