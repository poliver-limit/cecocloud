 ...
 */
@RestController
@RequestMapping(FactModuleConfig.API_PATH + "/ubicacions")
public class UbicacioApiController extends AbstractIdentificableWithIdentificadorApiController<Ubicacio> {
