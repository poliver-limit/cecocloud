...
/**
 * Test per a recursos de tipus punt de venda.
 * 
 * @author Limit Tecnologies <limit@limit.es>
 */
public class PuntVendaRestApiTest extends ModuleResourceRestApiTest<PuntVenda> {

	@Override
	protected CrudTester<PuntVenda> getCrudTester() {
		return new PuntVendaCrudTester();
	}
	...
	protected FuncionalitatCodiFont getFuncionalitatCodiFont() {
		...
		return moduleInfo.getFuncionalitats().get("FAC_PUNVEN");
	}
