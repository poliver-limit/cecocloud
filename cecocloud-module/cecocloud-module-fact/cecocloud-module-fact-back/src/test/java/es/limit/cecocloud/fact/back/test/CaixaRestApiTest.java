...
/**
 * Test per a recursos de tipus caixa.
 * 
 * @author Limit Tecnologies <limit@limit.es>
 */
public class CaixaRestApiTest extends ModuleResourceRestApiTest<Caixa> {

	@Override
	protected CrudTester<Caixa> getCrudTester() {
		return new CaixaCrudTester();
	}
	...
	protected FuncionalitatCodiFont getFuncionalitatCodiFont() {
		...
		return moduleInfo.getFuncionalitats().get("FAC_CAIXA");
	}
