...
/**
 * Test pels objectes de tipus articleModel.
 * 
 * @author Limit Tecnologies <limit@limit.es>
 */
public class ArticleModelRestApiTest extends ModuleResourceRestApiTest<ArticleModel> {
	...
	protected FuncionalitatCodiFont getFuncionalitatCodiFont() {
		...
		return moduleInfo.getFuncionalitats().get("FAC_MODART");
	}
