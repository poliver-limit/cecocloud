...
/** 
 * Conversor per a l'enumerat ArticleFamiliaTipusEnum
...
public class ArticleFamiliaTipusConverter extends AbstractEnumConverter<ArticleFamiliaTipusEnumDto, String> implements AttributeConverter<ArticleFamiliaTipusEnumDto, String>{

	public ArticleFamiliaTipusConverter() {
		super(ArticleFamiliaTipusEnumDto.class);
	}
}
