 ...
 */
public class CCEmpresaNotExistsValidator implements ConstraintValidator<CCEmpresaNotExists, CompteCorrentEmpresa> {
	...
	@Override
	public void initialize(final CCEmpresaNotExists constraintAnnotation) {	
