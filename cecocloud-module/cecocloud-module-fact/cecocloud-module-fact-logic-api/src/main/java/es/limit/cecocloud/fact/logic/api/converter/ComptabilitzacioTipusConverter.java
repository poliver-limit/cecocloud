...
/** 
 * Conversor per a l'enumerat ComptabilitzacioTipusEnum
 * A BBDD es desa com a String
 * 
 * Per tal de utilitzar-ho, a la entitat hibernate allà on es defineixi un atribut de tipus
 * ComptabilitzacioTipusEnum a convertir, se li ha d'afegir la anotació:
 * 
...
public class ComptabilitzacioTipusConverter extends AbstractEnumConverter<ComptabilitzacioTipusEnumDto, String> implements AttributeConverter<ComptabilitzacioTipusEnumDto, String> {

	public ComptabilitzacioTipusConverter() {
		super(ComptabilitzacioTipusEnumDto.class);
	}
