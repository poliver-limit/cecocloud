...
/** 
 * Conversor per a l'enumerat TipusComptabilitatClientEnum
 * A BBDD es desa com a String
 * 
 * Per tal de utilitzar-ho, a la entitat hibernate allà on es defineixi un atribut de tipus
 * TipusComptabilitatClientEnum a convertir, se li ha d'afegir la anotació:
 * 
...
public class TipusComptabilitatClientConverter extends AbstractEnumConverter<TipusComptabilitatClientEnumDto, String> implements AttributeConverter<TipusComptabilitatClientEnumDto, String> {

	public TipusComptabilitatClientConverter() {
		super(TipusComptabilitatClientEnumDto.class);
	}
