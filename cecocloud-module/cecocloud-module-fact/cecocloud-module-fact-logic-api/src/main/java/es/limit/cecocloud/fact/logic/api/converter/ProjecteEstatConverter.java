...
/** 
 * Conversor per a l'enumerat ProjecteEstatEnum
...
public class ProjecteEstatConverter extends AbstractEnumConverter<ProjecteEstatEnumDto, Integer> implements AttributeConverter<ProjecteEstatEnumDto, Integer>{

	public ProjecteEstatConverter() {
		super(ProjecteEstatEnumDto.class);
	}
}
