...
public class TipusVencimentConverter extends AbstractEnumConverter<TipusVencimentEnumDto, String> implements AttributeConverter<TipusVencimentEnumDto, String> {

	public TipusVencimentConverter() {
		super(TipusVencimentEnumDto.class);
	}
