...
/** 
 * Conversor per a l'enumerat ArticleFamiliaAvisAlbaraClientEnum
...
public class ArticleFamiliaAvisAlbaraClientConverter extends AbstractEnumConverter<ArticleFamiliaAvisAlbaraClientEnumDto, String> implements AttributeConverter<ArticleFamiliaAvisAlbaraClientEnumDto, String>{

	public ArticleFamiliaAvisAlbaraClientConverter() {
		super(ArticleFamiliaAvisAlbaraClientEnumDto.class);
	}
}
