...
/** 
 * Conversor per a l'enumerat ArticleFamiliaTipusServeiEnum
...
public class ArticleFamiliaTipusServeiConverter extends AbstractEnumConverter<ArticleFamiliaTipusServeiEnumDto, String> implements AttributeConverter<ArticleFamiliaTipusServeiEnumDto, String>{

	public ArticleFamiliaTipusServeiConverter() {
		super(ArticleFamiliaTipusServeiEnumDto.class);
	}
}
