...
/** 
 * Conversor per a l'enumerat AlbaraClientSubtipusEnumDto
 * A BBDD es desa com a Integer
 * 
 * Per tal de utilitzar-ho, a la entitat hibernate allà on es defineixi un atribut de tipus
 * AlbaraClientSubtipusEnumDto a convertir, se li ha d'afegir la anotació:
 * 
...
public class AlbaraClientSubtipusConverter extends AbstractEnumConverter<AlbaraClientSubtipusEnumDto, Integer> implements AttributeConverter<AlbaraClientSubtipusEnumDto, Integer> {

	public AlbaraClientSubtipusConverter() {
		super(AlbaraClientSubtipusEnumDto.class);
	}
