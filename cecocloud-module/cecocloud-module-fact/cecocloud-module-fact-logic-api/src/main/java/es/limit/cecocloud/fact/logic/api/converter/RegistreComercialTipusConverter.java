...
/** 
 * Conversor per a l'enumerat RegistreComercialTipusEnum
...
public class RegistreComercialTipusConverter extends AbstractEnumConverter<RegistreComercialTipusEnumDto, String> implements AttributeConverter<RegistreComercialTipusEnumDto, String>{

	public RegistreComercialTipusConverter() {
		super(RegistreComercialTipusEnumDto.class);
	}
}
