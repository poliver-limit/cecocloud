...
/** 
 * Conversor per a l'enumerat RebutsEnum
...
public class RebutsConverter extends AbstractEnumConverter<RebutsEnumDto, String> implements AttributeConverter<RebutsEnumDto, String> {

	public RebutsConverter() {
		super(RebutsEnumDto.class);
	}
