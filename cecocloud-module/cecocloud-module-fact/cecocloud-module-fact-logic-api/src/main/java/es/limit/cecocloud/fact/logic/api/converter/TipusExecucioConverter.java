...
public class TipusExecucioConverter extends AbstractEnumConverter<TipusExecucioEnumDto, Integer> implements AttributeConverter<TipusExecucioEnumDto, Integer> {
	
	public TipusExecucioConverter() {
		super(TipusExecucioEnumDto.class);
	}
}
