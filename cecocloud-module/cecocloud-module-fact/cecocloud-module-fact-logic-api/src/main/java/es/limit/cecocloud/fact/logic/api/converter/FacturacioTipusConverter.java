...
/** 
 * Conversor per a l'enumerat FacturaTipusConverter
 ...
 * 
 * @Convert(converter = FacturaTipusConverter.class)
 * 
...
public class FacturacioTipusConverter extends AbstractEnumConverter<FacturacioTipusEnum, Integer> implements AttributeConverter<FacturacioTipusEnum, Integer> {

	public FacturacioTipusConverter() {
		super(FacturacioTipusEnum.class);
	}
