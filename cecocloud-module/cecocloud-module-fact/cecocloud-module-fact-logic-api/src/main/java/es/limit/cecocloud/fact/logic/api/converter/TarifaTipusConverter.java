...
/** 
 * Conversor per a l'enumerat TarifaTipusEnum
...
public class TarifaTipusConverter extends AbstractEnumConverter<TarifaTipusEnumDto, String> implements AttributeConverter<TarifaTipusEnumDto, String> {

	public TarifaTipusConverter() {
		super(TarifaTipusEnumDto.class);
	}
