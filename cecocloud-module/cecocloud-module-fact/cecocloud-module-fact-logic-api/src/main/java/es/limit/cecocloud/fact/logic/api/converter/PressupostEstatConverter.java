...
public class PressupostEstatConverter extends AbstractEnumConverter<PressupostEstatEnumDto, String> implements AttributeConverter<PressupostEstatEnumDto, String> {

	public PressupostEstatConverter() {
		super(PressupostEstatEnumDto.class);
	}
