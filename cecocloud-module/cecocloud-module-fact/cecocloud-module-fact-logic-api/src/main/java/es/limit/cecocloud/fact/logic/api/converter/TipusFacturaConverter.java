...
/** 
 * Conversor per a l'enumerat TipusFacturaEnum
...
public class TipusFacturaConverter extends AbstractEnumConverter<TipusFacturaEnumDto, Integer> implements AttributeConverter<TipusFacturaEnumDto, Integer> {

	public TipusFacturaConverter() {
		super(TipusFacturaEnumDto.class);
	}
