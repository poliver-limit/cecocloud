...
/**
 * DTO enumerat amb els possibles tipus d'execució
 * 
 * Multiidioma
 * --------------------------------------------------------------------------------------
...
public enum TipusExecucioEnumDto implements ConvertedEnumInterface<Integer>{
	...
	private TipusExecucioEnumDto(Integer dbValue) {
