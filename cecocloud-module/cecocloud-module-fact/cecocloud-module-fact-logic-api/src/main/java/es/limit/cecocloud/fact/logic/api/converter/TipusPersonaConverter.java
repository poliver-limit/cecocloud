...
/** 
 * Conversor per a l'enumerat TipusPersonaEnum
...
public class TipusPersonaConverter extends AbstractEnumConverter<TipusPersonaEnumDto, String> implements AttributeConverter<TipusPersonaEnumDto, String> {

	public TipusPersonaConverter() {
		super(TipusPersonaEnumDto.class);
	}
