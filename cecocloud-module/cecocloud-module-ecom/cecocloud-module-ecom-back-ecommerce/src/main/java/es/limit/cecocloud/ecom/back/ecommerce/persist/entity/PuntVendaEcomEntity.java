...
import es.limit.cecocloud.ecom.back.ecommerce.logic.api.dto.PuntVendaEcom;
...
@Entity(name = "ecomBackPuntVendaEntity")
@Table(
		name = "tcom_ptv",
		indexes = {
...
public class PuntVendaEcomEntity extends AbstractWithIdentificadorAuditableEntity<PuntVendaEcom, PuntVendaPk> {

	@Embedded
	protected PuntVendaEcom embedded;
	...
	@Builder
	public PuntVendaEcomEntity(
			PuntVendaPk pk,
			PuntVendaEcom embedded,
	...
	@Override
	public void update(PuntVendaEcom embedded) {
		this.embedded = embedded;
	}
