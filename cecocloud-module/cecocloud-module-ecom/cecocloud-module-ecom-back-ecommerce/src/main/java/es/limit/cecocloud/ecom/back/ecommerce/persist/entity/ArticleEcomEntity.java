...
@Entity(name = "ecomBackArticleEcomEntity")
@Table(
		name = "tcom_art",
		indexes = {
...
public class ArticleEcomEntity extends AbstractWithIdentificadorAuditableEntity<ArticleEcom, WithIdentificadorAndCodiPk<String>> {

	@Embedded
	protected ArticleEcom embedded;
	...
	@Builder
	public ArticleEcomEntity(			
			WithIdentificadorAndCodiPk<String> pk,
			ArticleEcom embedded,
	...
	@Override
	public void update(ArticleEcom embedded) {
		this.embedded = embedded;
	}
