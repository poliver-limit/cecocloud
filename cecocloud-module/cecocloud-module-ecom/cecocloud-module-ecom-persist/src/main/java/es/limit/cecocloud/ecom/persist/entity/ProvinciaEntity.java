...
@Entity(name = "ecomProvinciaEntity")
@Table(
		name = "tcom_prv",
		indexes = {
...
@AssociationOverrides({
	@AssociationOverride(
			...
			foreignKey = @ForeignKey(name = "rcom_prv_idf_fk"))
})
public class ProvinciaEntity extends AbstractWithIdentificadorAuditableEntity<Provincia, ProvinciaPk> {
	...
	@JoinColumns(
			...
			foreignKey = @ForeignKey(name = "rcom_prv_pas_fk"))
