...
@Entity(name = "ecomPaisEntity")
@Table(
		name = "tcom_pas",
		indexes = {
				@Index(name = "icom_pas_idf_fk", columnList = "pas_idf_cod")
		}
)
@AttributeOverrides({
	@AttributeOverride(name = "id.identificadorCodi", column = @Column(name = "pas_idf_cod", length = 4)),
	@AttributeOverride(name = "id.codi", column = @Column(name = "pas_cod", length = 5)),
	...
	@AttributeOverride(name = "embedded.importRepartiment", column = @Column(name = "pas_irp")),
	@AttributeOverride(name = "embedded.importMinimRepartiment", column = @Column(name = "pas_imr")),
	@AttributeOverride(name = "embedded.importCompraNoPreuRepartiment", column = @Column(name = "pas_cmpnrp")),
...
@AssociationOverrides({
	@AssociationOverride(
			...
			foreignKey = @ForeignKey(name = "rcom_pas_idf_fk"))
})
