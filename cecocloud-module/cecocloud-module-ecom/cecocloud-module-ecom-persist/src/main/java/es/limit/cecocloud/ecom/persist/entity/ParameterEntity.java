...
@Entity(name = "ecomParameterEntity")
@Table(
		name = "tcom_par",
		indexes = {
				@Index(name = "icom_par_idf_fk", columnList = "par_idf_cod"),
				@Index(name = "ircom_par_pk", columnList = "par_idf_cod,par_cod", unique = true)
		}
...
@AssociationOverrides({
	@AssociationOverride(
			...
			foreignKey = @ForeignKey(name = "rcom_par_idf_fk"))
})
