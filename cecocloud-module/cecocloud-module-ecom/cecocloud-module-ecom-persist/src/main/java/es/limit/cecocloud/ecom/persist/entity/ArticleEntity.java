...
public class ArticleEntity extends AbstractWithIdentificadorAuditableEntity<Article, WithIdentificadorAndCodiPk<String>> {
	...
	@JoinColumns(
			...
			foreignKey = @ForeignKey(name = "rcom_art_emp_fk"))			
	...
	@JoinColumns(
			...
			foreignKey = @ForeignKey(name = "rcom_art_art_fk"))
	...
	@JoinColumns(
			...
			foreignKey = @ForeignKey(name = "rcom_art_art_cod02_fk"))
	...
	@JoinColumns(
			...
			foreignKey = @ForeignKey(name = "rcom_art_articleRaee_fk"))
