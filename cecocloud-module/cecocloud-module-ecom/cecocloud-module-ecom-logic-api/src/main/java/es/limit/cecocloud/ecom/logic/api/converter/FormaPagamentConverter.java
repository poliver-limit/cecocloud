...
public class FormaPagamentConverter extends AbstractEnumConverter<FormaPagamentEnumDto, String> implements AttributeConverter<FormaPagamentEnumDto, String> {

	public FormaPagamentConverter() {
		super(FormaPagamentEnumDto.class);
	}
