...
@AttributeOverrides({
	...
	@AttributeOverride(name = "embedded.diariContable", column = @Column(name = "serdricmp", length = 2)),			
	...
	@AttributeOverride(name = "embedded.facturaDesc", column = @Column(name = "ser_facturaDesc", length = 30)),		
