...
@Entity
@Table(	name = "tges_rgi",
		indexes = { @Index(name = "iges_rgi_idf_fk", columnList = "rgi_idf_cod"),
...
@AttributeOverrides({
	...
	// Propis de l'entitat (Definits anteriorment a la classe de la Entity ~ public class RegimIvaEntity)
...
public class RegimIvaEntity extends AbstractAuditableCompositePkEntity<RegimIva, RegimIvaPk> {
	...
	@JoinColumn(
			name = "rgi_idf_cod",
			foreignKey = @ForeignKey(name = "rges_rgi_idf_cod"),
