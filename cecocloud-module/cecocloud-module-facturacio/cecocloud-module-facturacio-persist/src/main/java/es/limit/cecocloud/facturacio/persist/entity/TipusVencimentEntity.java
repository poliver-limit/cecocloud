...
@Entity
@Table(	name = "tges_tve",
		indexes = { @Index(name = "iges_tve_idf_fk", columnList = "tve_idf_cod"),
...
@AttributeOverrides({
	...
	// Propis de l'entitat (Definits anteriorment a la classe de la Entity ~ public class TipusVencimentEntity)
...
public class TipusVencimentEntity extends AbstractAuditableCompositePkEntity<TipusVenciment, TipusVencimentPk> {
	...
	@JoinColumn(
			name = "tve_idf_cod",
			foreignKey = @ForeignKey(name = "rges_tve_idf_cod"),
