...
@Entity
@Table(	name = "tges_iva",
		indexes = { @Index(name = "iges_iva_idf_fk", columnList = "iva_idf_cod"),
...
@AttributeOverrides({
	...
	// Propis de l'entitat (Definits anteriorment a la classe de la Entity ~ public class IvaEntity)
...
public class IvaEntity extends AbstractAuditableCompositePkEntity<Iva, IvaPk> {
	...
	@JoinColumn(
			name = "iva_idf_cod",
			foreignKey = @ForeignKey(name = "rges_iva_idf_cod"),
