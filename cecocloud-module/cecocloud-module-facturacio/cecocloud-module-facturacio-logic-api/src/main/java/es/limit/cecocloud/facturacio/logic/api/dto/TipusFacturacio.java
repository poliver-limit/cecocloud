...
public class TipusFacturacio extends AbstractIdentificableWithCompositePk<TipusFacturacioPk> {
	...
	public static class TipusFacturacioPk implements Serializable {
