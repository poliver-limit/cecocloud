 ...
 */
@RestController
@RequestMapping(ApiControllerHelper.API_PATH + "/ives")
public class IvaApiController extends AbstractIdentificableApiController<Iva, String> {
	...
	@Override
	protected IvaService getService() {
		return service;
	}
