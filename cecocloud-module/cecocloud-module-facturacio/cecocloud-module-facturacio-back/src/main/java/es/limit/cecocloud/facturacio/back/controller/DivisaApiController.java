 ...
 */
@RestController
@RequestMapping(ApiControllerHelper.API_PATH + "/divises")
public class DivisaApiController extends AbstractIdentificableApiController<Divisa, String> {
	...
	@Override
	protected DivisaService getService() {
		return service;
	}

	@Override
	protected void completeDtoWithSession(Divisa dto, Object userSession) {
