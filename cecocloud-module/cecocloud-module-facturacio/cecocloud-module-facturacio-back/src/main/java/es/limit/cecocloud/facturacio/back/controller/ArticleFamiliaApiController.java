 ...
 */
@RestController
@RequestMapping(ApiControllerHelper.API_PATH + "/articlesFamilia")
public class ArticleFamiliaApiController extends AbstractIdentificableApiController<ArticleFamilia, String> {
