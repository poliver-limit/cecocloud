...
/**
 * Controlador per al servei REST de gestió de recursosGrup.
 * 
 * @author Limit Tecnologies <limit@limit.es>
 */
@RestController
@RequestMapping(ApiControllerHelper.API_PATH + "/recursosGrup")
public class RecursGrupApiController extends AbstractIdentificableApiController<RecursGrup, String> {

	@Autowired
	private RecursGrupService service;
	@Autowired
	private EmpresaService empresaService;
	
	@Override
	protected RecursGrupService getService() {
		return service;
	}
