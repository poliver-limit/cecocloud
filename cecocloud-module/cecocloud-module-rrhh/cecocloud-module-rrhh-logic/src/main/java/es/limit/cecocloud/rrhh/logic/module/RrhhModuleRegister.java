...
public class RrhhModuleRegister {
	...
	static {
		...
		funcionalitats.put("REH_ZONA", new FuncionalitatCodiFontImpl("REH_ZONA", FuncionalitatTipus.MANTENIMENT,
				"Zones",  Zona.class, Arrays.asList()));
