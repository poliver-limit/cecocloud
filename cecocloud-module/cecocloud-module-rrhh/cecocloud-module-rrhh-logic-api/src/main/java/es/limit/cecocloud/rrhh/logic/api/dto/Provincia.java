...
public class Provincia extends AbstractIdentificableWithIdentificador<ProvinciaPk> {
	...
	@Transient
	@NotNull
	@RestapiField(type = RestapiFieldType.LOV, disabledForUpdate = true, disabledForCreate = false)
	...
	public static class ProvinciaPk extends WithIdentificadorAndCodiPk<String> {
		...
		public ProvinciaPk(String identificadorCodi, String paisCodi, String codi) {
