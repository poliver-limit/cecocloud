...
import es.limit.cecocloud.rrhh.back.test.tester.PaisCrudTester;
 ...
 */
public class PaisRestApiTest extends ModuleResourceRestApiTest<Pais> {
	...
	protected FuncionalitatCodiFont getFuncionalitatCodiFont() {
		...
		return moduleInfo.getFuncionalitats().get("REH_PAIS");
	}
