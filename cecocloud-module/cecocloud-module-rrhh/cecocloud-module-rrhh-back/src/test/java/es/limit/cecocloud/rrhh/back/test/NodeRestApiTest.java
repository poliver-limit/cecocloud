...
import es.limit.cecocloud.rrhh.back.test.tester.NodeCrudTester;
import es.limit.cecocloud.rrhh.logic.api.dto.Node;
import es.limit.cecocloud.test.ModuleResourceRestApiTest;

/**
 * Test pels objectes de tipus node.
 * 
 * @author Limit Tecnologies <limit@limit.es>
 */
public class NodeRestApiTest extends ModuleResourceRestApiTest<Node> {

	@Override
	protected CrudTester<Node> getCrudTester() {
		return new NodeCrudTester();
	}
	...
	protected FuncionalitatCodiFont getFuncionalitatCodiFont() {
		...
		return moduleInfo.getFuncionalitats().get("REH_NODE");
	}
