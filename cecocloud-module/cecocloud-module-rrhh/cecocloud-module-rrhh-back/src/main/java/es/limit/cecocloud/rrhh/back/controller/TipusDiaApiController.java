...
public class TipusDiaApiController extends AbstractIdentificableApiController<TipusDia, String> {

	@Autowired
	private EmpresaService empresaService;

	@Override
	protected void completeDtoWithSession(TipusDia dto, Object userSession) {
