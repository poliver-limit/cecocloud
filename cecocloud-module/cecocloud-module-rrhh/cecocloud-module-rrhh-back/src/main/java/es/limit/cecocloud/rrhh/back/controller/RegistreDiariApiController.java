...
public class RegistreDiariApiController extends AbstractIdentificableApiController<RegistreDiari, String> {

	@Autowired
	private EmpresaService empresaService;

	@Override
	protected void completeDtoWithSession(RegistreDiari dto, Object userSession) {
