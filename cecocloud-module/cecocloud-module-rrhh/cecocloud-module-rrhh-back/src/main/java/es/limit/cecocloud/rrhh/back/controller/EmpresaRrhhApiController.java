...
public class EmpresaRrhhApiController extends AbstractIdentificableApiController<EmpresaRrhh, String> {

	@Autowired
	private EmpresaService empresaService;

	@Override
	protected void completeDtoWithSession(EmpresaRrhh dto, Object userSession) {
