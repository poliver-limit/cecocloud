 ...
 */
@RestController
@RequestMapping(RrhhModuleConfig.API_PATH + "/transaccions")
public class TransaccioApiController extends AbstractIdentificableAmbIdentificadorApiController<Transaccio> {
