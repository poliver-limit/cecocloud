...
public class ZonaRrhhEntity extends AbstractAuditableCompositePkEntity<ZonaRrhh, ZonaRrhhPk> {

	@Embedded
	protected ZonaRrhh embedded;
	...
	@Override
	public void update(ZonaRrhh embedded) {
		this.embedded = embedded;
	}
