...
@Entity(name = "rrhhCodiPostalEntity")
@Table(
		name = "tges_cpo", 
		indexes = { 
...
@AttributeOverrides({
		...
		@AttributeOverride(name = "embedded.codi", column = @Column(name = "cpo_cod", insertable = false, updatable = false)),
...
@AssociationOverrides({ 
	@AssociationOverride(
			...
			joinColumns = {
					@JoinColumn(
							name = "cpo_idf_cod", insertable = false, updatable = false) }, 
			foreignKey = @ForeignKey(name = "rges_cpo_idf_fk")) 
	})
public class CodiPostalEntity
		extends AbstractWithIdentificadorAuditableEntity<CodiPostal, WithIdentificadorAndCodiPk<String>> {
	...
	@JoinColumns(value = {
			...
			@JoinColumn(name = "cpo_pas_cod", referencedColumnName = "pas_cod", insertable = false, updatable = false) }, foreignKey = @ForeignKey(name = "rges_cpo_pas_fk"))
	...
	@JoinColumns(value = {
			...
			@JoinColumn(name = "cpo_prv_cod", referencedColumnName = "prv_cod", insertable = false, updatable = false) }, foreignKey = @ForeignKey(name = "rges_cpo_prv_fk"))
