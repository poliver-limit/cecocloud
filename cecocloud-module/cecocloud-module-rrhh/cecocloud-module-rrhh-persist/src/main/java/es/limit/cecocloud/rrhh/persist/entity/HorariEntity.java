...
@AssociationOverrides({
	@AssociationOverride(
			name = "identificador",
			joinColumns = {
					@JoinColumn(name = "hor_idf_cod", foreignKey = @ForeignKey(name = "rrhu_hor_idf_fk"), insertable = false, updatable = false)
			})
})
public class HorariEntity extends AbstractAmbIdentificadorEntity<Horari, AmbIdentificadorICodiPk<String>> {
