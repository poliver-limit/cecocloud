...
public class EmpresaRrhhEntity extends AbstractAuditableCompositePkEntity<EmpresaRrhh, EmpresaRrhhPk> {

	@Embedded
	protected EmpresaRrhh embedded;
	...
	@Builder
	public EmpresaRrhhEntity(
			EmpresaRrhhPk pk,
			EmpresaRrhh embedded,
	...
	@Override
	public void update(EmpresaRrhh embedded) {
		this.embedded = embedded;
	}
