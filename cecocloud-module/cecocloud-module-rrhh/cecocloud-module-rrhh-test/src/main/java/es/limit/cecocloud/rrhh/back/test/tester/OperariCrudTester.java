...
public class OperariCrudTester extends AbstractCrudTester<Operari> {
	...
	public Operari createDto() {
		...
		dto.setCentre(getGenericReferenceWithCompositePk(Centre.class));
		dto.setEmpresa(getGenericReferenceWithCompositePk(Empresa.class));
		dto.setGrupFestiu(getGenericReferenceWithCompositePk(GrupFestiu.class));
		dto.setHorari(getGenericReferenceWithCompositePk(Horari.class));
		dto.setHorariBocadillo(getGenericReferenceWithCompositePk(Horari.class));
		dto.setHorariCod003(getGenericReferenceWithCompositePk(Horari.class));
		dto.setHorariCodNit(getGenericReferenceWithCompositePk(Horari.class));
		dto.setMantenimentDeTipus(getGenericReferenceWithCompositePk(MantenimentDeTipus.class));
		dto.setRecursGrup(getGenericReferenceWithCompositePk(RecursGrup.class));
		dto.setTipusComissio(getGenericReferenceWithCompositePk(TipusComissio.class));
		dto.setTorn(getGenericReferenceWithCompositePk(Torn.class));
